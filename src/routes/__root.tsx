    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          "@id": "https://agsoftener.com/#organization",
          name: "AG Water Softener",
          url: "https://agsoftener.com",
          email: "support@agsoftener.com",
          sameAs: ["https://www.youtube.com/@agsoftener"],
          parentOrganization: {
            "@type": "Organization",
            name: "GRN Labs",
...
function RootComponent() {
  ...
  useEffect(() => {
    const unsub = router.subscribe("onResolved", () => {
      ...
      if (typeof window !== "undefined" && typeof window.fbq === "function" && localStorage.getItem("ag_internal") !== "1") {
        window.fbq("track", "PageView", {}, { eventID: Date.now() + "-" + Math.random().toString(36).slice(2, 10) });
      }
    });
    return unsub;
  }, [router]);
