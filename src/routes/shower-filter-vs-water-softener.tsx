    ...
    <div className="min-h-screen bg-background">
      ...
      <article className="mx-auto max-w-[760px] px-5 py-12 md:px-8 md:py-16 lg:py-24">
        ...
        <div className="mt-8 space-y-6 text-[15px] leading-[1.7] text-foreground/90">
          <p>
            A shower filter removes chemicals from your water. A water softener removes minerals. People compare the two because both screw onto a shower and both promise better hair and skin, but if you buy the wrong one, your water problem stays exactly where it was, and you'll blame the product instead of the mismatch.
          </p>
