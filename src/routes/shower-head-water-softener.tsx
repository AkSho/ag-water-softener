    ...
    <div className="min-h-screen bg-background">
      ...
      <article className="mx-auto max-w-[760px] px-5 py-12 md:px-8 md:py-16 lg:py-24">
        ...
        <div className="mt-6 space-y-6 text-[15px] leading-[1.7] text-foreground/90">
          ...
          <p>
            Yes, that's more than $18. It's also the difference between buying a softener and buying the word. For the full side-by-side, read <a href="/shower-filter-vs-water-softener" className="underline hover:opacity-70">the filter vs softener comparison</a>. The full field is ranked in <a href="/best-shower-water-softener" className="underline hover:opacity-70">our shower water softener list</a>. Renters have a separate guide to putting a <a href="/water-softener-for-apartment" className="underline hover:opacity-70">water softener in an apartment</a>.
          </p>
        </div>
